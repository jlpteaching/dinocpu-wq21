...
//  val tests = List(
//    // alu,   itype,    Funct7,       Func3,    Control Input
//    (  true.B, false.B,  "b0000000".U, "b000".U, "b1101".U, "beq"),
//    (  true.B, false.B,  "b0000000".U, "b001".U, "b1110".U, "bne"),
//    (  true.B, false.B,  "b0000000".U, "b100".U, "b1000".U, "blt"),
//    (  true.B, false.B,  "b0000000".U, "b101".U, "b1011".U, "bge"),
//    (  true.B, false.B,  "b0000000".U, "b110".U, "b0101".U, "bltu"),
//    (  true.B, false.B,  "b0000000".U, "b111".U, "b1100".U, "bgeu")
//  )
//
//  for (t <- tests) {
//    poke(ctl.io.aluop, t._1)
