...
**Due on 1/17**: See [Submission](#submission) for details
...
However, if you run into any problems, post on [Discord](https://discord.com/channels/791087361273757726/791421928597880842) or come to office hours.
...
```
Let us know if you would like more details on this method via [Discord](https://discord.com/channels/791087361273757726/791421928597880842).
...
You can find the code for this program in [`src/test/resources/risc-v/add1.riscv`](https://github.com/jlpteaching/dinocpu-wq21/blob/main/src/test/resources/risc-v/add1.riscv) and below:
...
You will upload the two files that you changed to Gradescope on the [Lab 1](https://www.gradescope.com/courses/216663/assignments/923457/) assignment.
